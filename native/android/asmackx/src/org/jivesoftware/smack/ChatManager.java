...
public class ChatManager {
    ...
    void sendMessage(Chat chat, Message message) {
    	Log.d("ChatManager", "sendMessage(this, message); START " + (int)(System.currentTimeMillis() / 1000L ));
        ...
        Log.d("ChatManager", "sendPacket(message); BEFORE " + (int)(System.currentTimeMillis() / 1000L ));
        connection.sendPacket(message);
        Log.d("ChatManager", "sendPacket(message); AFTER " + (int)(System.currentTimeMillis() / 1000L ));
    }
