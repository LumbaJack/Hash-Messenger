...
public class Chat {
    ...
    public void sendMessage(Message message) throws XMPPException {
        ...
        message.setThread(threadID);
        Log.d("Chat", "chatManager.sendMessage(this, message); BEFORE " + (int)(System.currentTimeMillis() / 1000L ));
        chatManager.sendMessage(this, message);
        Log.d("Chat", "chatManager.sendMessage(this, message); AFTER " + (int)(System.currentTimeMillis() / 1000L ));
    }
